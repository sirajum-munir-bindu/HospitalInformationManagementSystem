...
<div class="container mt-5">
    <div class="row mb-4">
        <div class="col-12 text-center">
            <h2 class="fw-bold text-success mt-4">Meet Our Specialist Doctors</h2>
            <hr class="w-25 mx-auto border-3 border-success opacity-75" />
            <p class="text-muted">Choose the best doctors from our expert panel for your health needs.</p>
        </div>
    </div>
